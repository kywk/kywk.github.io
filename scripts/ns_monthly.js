...
var beginDate = new Date(firstDateOfMonth.getTime() - (weekdayOfFirstDate - 2) * MILLISECOND_OF_DAY);

var lastDayOfMonth = new Date(firstDateOfMonth.getFullYear(), firstDateOfMonth.getMonth()+1, 0, 0, 0, 0);
if (lastDayOfMonth.getDay() <= 5)
  var endDate = new Date(lastDayOfMonth.getTime() - (lastDayOfMonth.getDay() + 5) * MILLISECOND_OF_DAY);
else
  var endDate = new Date(lastDayOfMonth.getTime() - (lastDayOfMonth.getDay() - 2) * MILLISECOND_OF_DAY);
